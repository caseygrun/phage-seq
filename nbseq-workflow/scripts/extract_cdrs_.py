...
with snakemake_log(snakemake) as logfile:
	...
	for library in snakemake.params['library_CDRs']:
		...
		cdrs = cdrs[['clonotypeID','CDR3ID','clonotype','CDR1','CDR2','CDR3','library']]
		cdr_dfs.append(cdrs)
